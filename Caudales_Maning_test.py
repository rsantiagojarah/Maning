...
# Override file paths for automated testing
AUTOMATED_MODE = len(sys.argv) > 2
if AUTOMATED_MODE:
    archivo_entrada = sys.argv[1]
    archivo_salida = sys.argv[2]
    print(f"AUTOMATED MODE: Input={archivo_entrada}, Output={archivo_salida}")
else:
...
try:
    ...
    try:
        ...
        print(f"SUCCESS: File saved to {archivo_salida}")
        if not AUTOMATED_MODE:
